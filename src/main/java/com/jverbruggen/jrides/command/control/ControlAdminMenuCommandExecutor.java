...
public class ControlAdminMenuCommandExecutor extends BaseCommandExecutor {
    ...
    public boolean onCommand(CommandSender commandSender, Command command, String s, String[] args, CommandContext commandContext) {
        ...
        if(!commandSender.hasPermission(Permissions.COMMAND_ADMIN_MENU)){
        ...
        RideControlMenu rideControlMenu = rideControlMenuFactory.getAdminMenu(rideHandle.getRideController());
