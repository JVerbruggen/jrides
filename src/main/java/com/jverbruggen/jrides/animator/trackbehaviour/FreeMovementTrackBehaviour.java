...
//        final double gravityAccelerationPerTick = 2;
        ...
        int newMassMiddleFrame = Math.floorMod(currentMassMiddleFrame + frameIncrement, frameCount);

        NoLimitsExportPositionRecord position = track.getRawPositions().get(newMassMiddleFrame);
