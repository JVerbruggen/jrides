...
import com.jverbruggen.jrides.config.flatride.structure.rotor.attachment.AttachmentConfig;
import com.jverbruggen.jrides.config.flatride.structure.rotor.attachment.FixedAttachmentConfig;
import com.jverbruggen.jrides.config.flatride.structure.rotor.attachment.RelativeMultipleRotorAttachmentConfig;
...
public class RotorConfig extends BaseConfig implements StructureConfigItem {
    ...
    public RotorConfig(String identifier, boolean root, String rotorAxis, String rotorControl, String rotorControlPlayerAcc, RotorSpeed rotorSpeed, AttachmentConfig attachmentConfig, List<ModelConfig> flatRideModels) {
    ...
    @Override
    public void createAndAddTo(List<FlatRideComponent> components) {
        attachmentConfig.createRotorWithAttachment(this, components);
    }
    ...
    public static StructureConfigItem fromConfigurationSection(ConfigurationSection configurationSection, String identifier) {
        ...
        if(configurationSection.contains("arm")){
            ...
            attachmentConfig = RelativeMultipleRotorAttachmentConfig.fromConfigurationSection(configurationSection);
        }
